...
export default function HomePage() {
  return (
    <>
      ...
      <section className="py-20 bg-riara-secondary-light">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="flex items-center justify-center mb-4">
              <Calendar className="w-8 h-8 text-riara-primary mr-3" />
      ...
      <section className="py-20 bg-gradient-to-br from-riara-primary via-riara-primary to-riara-primary-dark text-white">
